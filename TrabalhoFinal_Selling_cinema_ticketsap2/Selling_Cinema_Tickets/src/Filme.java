...
public class Filme extends Cartaz {
	...
	public void adicionarFilmeVazio() {
		setNomeFilme("");
		setIdFilme(0);
		setValorFilme(0);
		setTempoFilme("");
		setClassificacaoIdade(0);
		setSessoes(sessoes);
	}
	...
	public void deletarFilme(int idParaDeletar) {
		for (int i = 0; i <= 25; i++) {
		if(filmes[i].getIdFilme() == idParaDeletar) {
			filmes[i].adicionarFilmeVazio();
			}
		}
	}
